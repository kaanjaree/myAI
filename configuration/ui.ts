...
export const CHAT_HEADER: string = `BookBot - Barnes and Noble AI Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Kaanjaree Nune @ UNC-CH`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `Barnes and Noble AI Assistant`;
